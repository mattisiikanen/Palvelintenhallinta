...
Lopuksi klikkaa Install -> Yes -> Finish (loppu kohdassa voidaan valita Start Salt-minion tai käyttää delayed startia, asennuksen kannalta asialla ei ole merkitystä). Asennuksen siirryttiin Linux-herra koneelle tarkastamaan lähettikö Windows-orja Salt avaimet: </br>
...
Seuraavaksi lisäsin vielä tilaan oman osion Chocolateylle: </br>
```
mkdir c:\temp:
 cmd.run:
  - creates: c:\temp
